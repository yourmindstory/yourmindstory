...
function track(name,params){params=params||{};params.page_path=location.pathname;params.page_title=document.title;if(typeof window.gtag==='function')window.gtag('event',name,params);}
