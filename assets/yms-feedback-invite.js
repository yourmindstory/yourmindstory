  ...
  function mount() {
    ...
    wrap.innerHTML =
      '<div style="border:1px solid rgba(36,61,46,.16);border-radius:16px;padding:22px;background:#fff;">' +
        ...
        '<p style="margin:0 0 10px;"><strong>And when you finish, I’ll give you my 2-Minute Emergency Reset</strong> - a short guided audio to use in the day when your mind starts spiralling, you want to check, message, replay everything, or you can feel yourself getting pulled back in.</p>' +
